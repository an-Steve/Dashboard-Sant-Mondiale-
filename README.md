...
##  Démo en direct
[👉 Cliquez ici pour voir le Dashboard en ligne](https://an-steve.github.io/Dashboard-Sante-Mondiale-/) 
...
| :--- | :--- | :--- |
| **Espérance de vie** | ans | Moyenne de longévité à la naissance. |
| **Mortalité infantile** | ‰ | Taux de décès pour 1000 naissances. |
| **Dépenses Santé** | % PIB | Part de la richesse nationale allouée à la santé. |
| **Surpoids** | % | Part de la population adulte concernée. |
